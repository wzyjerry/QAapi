...
import codecs
import unicodedata
from util.ner_utils import create_dico, create_mapping, zero_digits
from util.ner_utils import iob2, iob_iobes
import string
import random
import numpy as np
import model
...
def get_batch(start, batch_size, datas, singletons=[]):
    ...
    input_seqs, target_seqs, chars2_seqs = list(zip(*seq_pairs))
